...
const items = [
  ...
  { label: "Settings", href: "/manager/settings", available: false, path: "m9 3-1 3-3 1-2 3 2 2-1 4 3 2 2-1 3 4 3-2v-3l4-1 2-3-3-2V6l-4-1-2-2H9ZM15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0" },
] as const;

export function ManagerBottomNav({ active }: { active: "Home" | "Bookings" | "Analytics" }) {
