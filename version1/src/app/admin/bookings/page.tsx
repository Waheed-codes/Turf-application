...
import { type AdminBooking, type BookingAction, simulateBookingAction, BOOKINGS_TODAY, mockAdminBookings, bookingContext, bookingDate, bookingTime, bookingsCsv, statusLabel } from "@/data/admin/mockAdminBookings";
...
export default function AdminBookingsPage() {
  ...
  function updateBooking(action: BookingAction) {
    ...
    const updated = simulateBookingAction(selectedBooking, action);
  ...
  return <div className="space-y-6">
    ...
    {selectedBooking !== null && <AdminBookingDetails booking={selectedBooking} onClose={() => setSelectedBooking(null)} onAction={updateBooking} />}
  </div>;
}
